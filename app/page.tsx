  ...
  return (
    <main className="grid place-content-center md:h-screen">
      ...
      <div className="max-w-lg grid gap-4 m-6 sm:m-12">
        ...
        <p>
          As I wrote this, well, I guess I experienced one of those moments.
        </p>
        <p>
          Regardless of my intrusive thoughts, I’d like to make you a pizza sometime. So, if one of the pictures catches your eye, or maybe you even want to learn from someone with a little bit of experience (while we make pizza, of course), send me an email. It’d be cool to hear from you.
        </p>
